(function ($)
{
     ...
     *
     * @type {{tagClass: tagClass, itemValue: itemValue, itemText: itemText, itemTitle: itemTitle, itemIcon: itemIcon, freeInput: boolean, addOnBlur: boolean, maxTags: undefined, maxChars: undefined, confirmKeys: number[], onTagExists: onTagExists, trimValue: boolean, allowDuplicates: boolean}}
     */
    var defaultOptions = {
        tagClass        : tagClass,
        itemValue       : itemValue,
    ...
    TagsMaterialize.prototype = {
        ...
        add : function (item, dontPushVal, options)
        {
            ...
            var itemValue = self.options.itemValue(item),
                ...
                itemIcon  = self.options.itemIcon(item),
            ...
            // add a tag element
            var $tag = $('<span class="' + htmlEncode(tagClass) + (itemTitle !== null ? ('" title="' + itemTitle) : '') + '">' + (itemIcon !== null ? ('<i class="material-icons left">' + itemIcon + '</i>') : '') + htmlEncode(itemText) + '<i class="material-icons" data-role="remove">close</i></span>');
            $tag.data('item', item);
